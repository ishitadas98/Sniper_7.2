...
namespace ParametricDramDirectoryMSI
{
   ...
   class CacheParameters
   {
	 ...
	 ComponentLatency data_write_time;
	    ...
	    , data_write_time(NULL,0)
         ...
         CacheParameters(
            ...
            const ComponentLatency& _data_access_time, const ComponentLatency& _tags_access_time,  const ComponentLatency& _data_write_time,
         ...
         :
            ...
            data_access_time(_data_access_time), tags_access_time(_tags_access_time), data_write_time(_data_write_time),
   ...
   class CacheCntlr : ::CacheCntlr
   {
	 ...
	 ComponentLatency m_data_write_time;
         ...
         SharedCacheBlockInfo* getCacheBlockInfo2(IntPtr address);
         ...
         void writeCacheBlock(IntPtr address, UInt32 offset, Byte* data_buf, UInt32 data_length, ShmemPerfModel::Thread_t thread_num, CacheBlockInfo *evict_block_info, bool eviction);
