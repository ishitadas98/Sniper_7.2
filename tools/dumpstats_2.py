...
import sys, os, getopt, sniper_lib_2, sniper_stats
...
if do_config:
  config = sniper_lib_2.get_config(resultsdir = resultsdir, jobid = jobid)
...
if do_stats:
  ...
  if through_time:
    ...
    with sniper_lib_2.OutputToLess():
    ...
    results = sniper_lib_2.get_results(jobid, resultsdir, partial = partial)
